...
public class Scanning_Barcode_Activity_With_Fragment extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplication(), Scanning_Barcode_Manual_Input_Activity.class); //go to the next screen
    ...
    protected void onStart() {
        ...
        if (PermissionUtils.isPermissionGrantedInActivity(
                ...
                new Runnable() {
                    @Override
                    public void run() {
                        Scanning_Barcode_Activity_With_Fragment.this.finish();
                    }
                }
        )) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            final Dialog dialog = new Dialog(Scanning_Barcode_Activity_With_Fragment.this);
