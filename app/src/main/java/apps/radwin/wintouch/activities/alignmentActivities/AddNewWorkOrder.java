...
public class AddNewWorkOrder extends AppCompatActivity
    ...
    Boolean checkmarkPressef = false;
            ...
            public void onClick(View view) {
                ...
                Thread geoThread = new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            hasInternet = wifiWrapper.hasInternetAccess(AddNewWorkOrder.this);
...
//
        ...
        if (isInEditMode) { // checks if the user is in edit mode
            ...
            analyticsTracker.setScreenName("Edit Work Order");
    ...
    private void showAddressList(final ArrayList<Address> arr) {
        ...
        try {
            ...
            AlertDialog.Builder builderSingle = new AlertDialog.Builder(AddNewWorkOrder.this);
            builderSingle.setIcon(R.drawable.ic_my_location_black_24dp);
            builderSingle.setTitle("Select Address");

            final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(
                    AddNewWorkOrder.this, android.R.layout.select_dialog_singlechoice);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.checkMarkButton) {
            if(WifiUtils.isPoorNetworkAvoidanceEnabled(AddNewWorkOrder.this)) {
                new android.support.v7.app.AlertDialog.Builder(AddNewWorkOrder.this)
                        ...
                        .setPositiveButton(R.string.WifiPopupPositive, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                WifiUtils.showAdvancedWifiIfAvailable(AddNewWorkOrder.this);
                                dialog.dismiss();
                            }
                        })
...
//                }
    ...
    public Boolean onSaveButton(boolean startAlign) {
        final Runnable runnable = new Runnable() {
            @Override
            public void run() {
                beginAlignmentButton.setEnabled(true);
            }
        };
        beginAlignmentButton.setEnabled(false);
                                ...
                                .setPositiveButton("Proceed", new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int which) {
                                        if (onSaveButton(true)) {
                                            if (PermissionUtils.isPermissionGrantedInActivity(AddNewWorkOrder.this, Manifest.permission.CAMERA)) {
                                                startAlignment();
                                            }
                                        } else {
                                            Toast.makeText(getApplication(), getResources().getString(R.string.loadingAddress), Toast.LENGTH_SHORT).show();
