...
public class Scanning_Barcode_Manual_Input_Activity extends AppCompatActivity
    ...
    public void onSavePressed() {
        ...
        if (manualInputText.getText().length() > 0) {
            ...
            if (validateSSID(String.valueOf(manualInputText.getText()))) {
                ...
                new AlertDialog.Builder(Scanning_Barcode_Manual_Input_Activity.this)
                        .setTitle("Results")
                        .setCancelable(false)
            ...
            Toast.makeText(Scanning_Barcode_Manual_Input_Activity.this, getResources().getString(R.string.manual_bacode_enter_sn),
    ...
    private boolean validateSSID(String text) {
        if (text.length() == 16) {
            if (text.matches("[A-Za-z0-9]+")) {
                ...
                Toast.makeText(Scanning_Barcode_Manual_Input_Activity.this, R.string.mainual_ssid_barcode_charechters_error,
                        Toast.LENGTH_LONG).show();
                return false;
            }

        } else {
            Toast.makeText(Scanning_Barcode_Manual_Input_Activity.this, R.string.mainual_ssid_barcode_langth_error,
                    Toast.LENGTH_LONG).show();
            return false;
